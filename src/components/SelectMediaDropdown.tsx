  ...
  return (
    <>
      <div className="mr-4 flex">
        <button type="button" className="btn btn-sm md:btn-md glass md:rounded-r-none" onClick={buttonProps.onClick ? buttonProps.onClick : () => {
        }}>{enabled ? enabledIcon : disabledIcon}</button>
        <div className="dropdown hidden md:block">
          <label tabIndex={0} className="btn btn-sm md:btn-md glass rounded-l-none"><FaChevronDown className="text-lg"/></label>
